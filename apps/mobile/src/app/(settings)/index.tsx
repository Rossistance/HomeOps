...
export default function SettingsScreen() {
  ...
  const load = useCallback(async () => {
    const [mem, provs, conns] = await Promise.all([api.members(), api.providers(), api.connectors()]);
    setMembers(mem);
    ...
    <HScreen refreshing={refreshing} onRefresh={onRefresh}>
          ...
          <Rise index={2}>
            ...
            <Card padded={false}>
              ...
              <Row
                ...
                subtitle="Members, spaces and invites"
                chevron
      ...
      <Rise index={6}>
        <View style={{ alignItems: "center", gap: 6, marginTop: spacing.sm }}>
          <HuddleMark size={28} />
          <T kind="detail">FamiliOS {version} · Hearth — {dark ? "Dark" : "Light"}</T>
        </View>
      </Rise>
