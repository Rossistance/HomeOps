...
const VERSION = "1.4.1"; // 1.4.1: a session in use renews (12h is an idle limit, 30 days absolute). 1.4: Rung 4 (ADR-004) — native tools behind the gate, plan_meal declared, a child's group write waits for an adult
